        ...
        for (const uri of uniqueFiles) {
            ...
            if (byLanguage) {
                if (byLanguage.isCustom) {
                    ...
                    const defaultCfg = fileTrackerDefaults_1.DEFAULT_LANGUAGE_CONFIGS.find(c => c.languageId === languageId);
                ...
                if (byExtension) {
                    if (byExtension.isCustom) {
                        ...
                        const defaultCfg = fileTrackerDefaults_1.DEFAULT_LANGUAGE_CONFIGS.find(c => c.extension === ext);
